'use client'
import { useCategoriesQuery, useCreateLostItemsMutation } from "@/redux/api/baseApi";
...
const page = () => {
  ...
  const [createLostItems] = useCreateLostItemsMutation()
...
const handleSubmit = async (e: FormEvent) => {
  ...
  try {
    ...
    const res = await createLostItems(lostItemsInfo)
      ...
      <div className=" p-2">
        <form onSubmit={handleSubmit} className="flex flex-wrap gap-2 mt-8 md:w-[80%] mx-auto">
          ...
          <div className="md:w-[50%] md:ml-0 ml-[5%]">
            ...
            <br />
          <input name="lostDate" onChange={handleInputChange} className="lost-input" type="date" placeholder="Date lost" />
          </div>
